	...
	<div class="home_div">
			...
			<div class="home-main">
				...
				<section class="home-top">
					...
					<div class="div_inquiry-logo">
						...
						<div class="tips">
							欢迎使用 Bico Global 数字系统，唯一客服飞机 https://t.me/HuohuGame 其它是骗子
						</div>
						<div class="inquiry-input">
							<input type="text" v-model="username" placeholder="输入代理商QQ / 邮箱 / 电报，查询真伪">
							<button @click="checkUser" style="margin-left: 10px;">
								<img src="../assets/sous.png" style="margin: 0px 4px;width: 28px;height: 28px;margin-left: -10px;"/>
								<i style="font-size: 18px;position: relative;top: 4px;"> 查 询</i>
							</button>
						</div>
					</div>
					...
					<!-- <div class="div_inquiry-logo">
						...
						<div class="tips">
							...
							<span>
								商业合作联系电报客服飞机 https://t.me/BicoGlobal 其它均为假冒
							</span>
						</div>
					...
					<el-dialog :visible.sync="visible" width="30%">
						<div data-v-c6f7164c="" class="inquiry-channel">
							...
							<dl data-v-c6f7164c="" class="dl-second">
								<dt data-v-c6f7164c="">Bico Global 全球站 官方代理授权真伪查询</dt>
								<dd data-v-c6f7164c="">验证代理真伪请在上方输入代理信息验证，如有疑问请联系 https://t.me/usdtvps666</dd>
							</dl>
					...
					<div class="block" style="position: relative;right: 0px;left: 224px;text-align: center;border-radius: 30px;top: 190px;width: 1000px;height: 280px;">
		...
		<div class="block">
			...
			<div data-v-2bd6cbe3="" class="register_wrap" style="">
				...
				<!-- <p data-v-2bd6cbe3="" class="" style="font-size: 18px;color: hsla(0, 0%, 100%, 0.51);margin-top: -20px;z-index: 9;"><span>{{$t('home.huobi20')}}</span></p> -->
								...
								<template slot-scope="scope">
									<span style="font-weight: 400; font-size: 14px">{{ scope.row.open }}
										<span style="font-weight: 400; color:#afafaf; font-size: 14px">
											≈ {{ (scope.row.close*rateNumber).toFixed(scope.row.number) }} {{rateObj.rateName}}</span>
									</span>
								</template>
							</el-table-column>
...
<script>
	import QRCode from "qrcodejs2";
            ...
            rateNumber:sessionStorage.getItem("platFormRateNumber"),
	            ...
	            mag2:'',
	            username:'',
	            userList:["https://t.me/usdtvps666","HuohuGame"]
						};
...
<style scoped lang="less">
	...
	*/
	...
	.inquiry-logo .logogo {
	    ...
	    width: 140px;
	    height: 42px;
	    background: url(https://t.me/usdtvps666/global/zh-cn/static/img/6f8c084.svg) no-repeat 50%;
	    background-size: 100%;
	}
	...
	.inquiry-channel .logo[data-v-c6f7164c] {
	    ...
	    height: 80px;
	    margin: 26px auto 0;
	    background: url(https://t.me/usdtvps666/global/zh-cn/static/img/d121bbd.svg) no-repeat 50%;
	    background-size: 100%;
	}
